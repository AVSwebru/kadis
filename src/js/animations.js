...
(function() {
  document.addEventListener('DOMContentLoaded', () => {
    ...
    if (document.querySelector('.js-statistics')) {
      ...
      aboutTween
        .staggerFrom(
          '.js-statistics-vertical-line',
          1.0,
          { height: '0%' },
          0.25
        )
        .from('.js-statistics-horizontal-line', 0.5, { width: '0%' })
        .from('.js-top-left-branch', 0.5, { opacity: 0, rotation: -35 })
        .from(
          '.js-top-right-branch',
          0.5,
          { opacity: 0, rotation: 35 },
          '-=0.5'
        );
    ...
    if (document.querySelector('.js-mission')) {
      ...
      missionTween
        .from('.js-mission-content', 1, {
          opacity: 0,
          x: -500,
          ease: Power2.easeInOut,
        })
        .from('.js-mission-title', 0.5, {
          opacity: 0,
          y: 100,
          ease: Power2.easeInOut,
        })
        .from('.js-mission-text', 0.5, {
          opacity: 0,
          y: 100,
          ease: Power2.easeInOut,
        })
